// app/admin/news/(components)/AdminNewsClient.jsx
"use client";
              ...
              {editingItem?.id === item.id ? (
                ...
                <>
                  ...
                  <div className={styles.actions}>
                    <a
                      href={`${process.env.NEXT_PUBLIC_AZURE_BLOB_BASE_URL}/${item.blobId}?${process.env.NEXT_PUBLIC_AZURE_BLOB_SAS_TOKEN}`}
                      target="_blank"
