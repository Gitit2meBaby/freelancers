    ...
    <footer className={styles.footer}>
          ...
          <div>
              ...
              <ul>
                  ...
                  <li><Link href="/screen-services">Screen Services</Link></li>
                  <li><Link href="/booking-guidelines">Booking Guidelines</Link></li>
          ...
          <div>
              ...
              <ul>
                  ...
                  <li><Link href="mailto:info@freelancers.com.au">info@freelancers.com.au</Link></li>
              </ul>
      </div>
    </footer>
  )
